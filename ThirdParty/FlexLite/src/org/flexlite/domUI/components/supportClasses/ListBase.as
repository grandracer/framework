	...
	public class ListBase extends SkinnableDataContainer
	{
		...
		override protected function partAdded(partName:String, instance:Object):void
		{
			...
			if (instance == dataGroup)
			{
				...
				_eventBinder.addListener(dataGroup, RendererExistenceEvent.RENDERER_DATA_CHANGE, dataGroup_rendererDataChangeHandler);
			}
		}
		...
		override protected function partRemoved(partName:String, instance:Object):void
		{
			...
			if (instance == dataGroup)
			{
				_eventBinder.removeListener(dataGroup, RendererExistenceEvent.RENDERER_ADD, dataGroup_rendererAddHandler);
				_eventBinder.removeListener(dataGroup, RendererExistenceEvent.RENDERER_REMOVE, dataGroup_rendererRemoveHandler);
				_eventBinder.removeListener(dataGroup, RendererExistenceEvent.RENDERER_DATA_CHANGE, dataGroup_rendererDataChangeHandler);
			}
		}
