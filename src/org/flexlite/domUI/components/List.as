package org.flexlite.domUI.components
{
	...
	public class List extends ListBase
	{
		...
		protected function item_mouseDownHandler(event:MouseEvent):void
		{
			...
			_eventBinder.addListener(DomGlobals.stage, MouseEvent.MOUSE_UP,stage_mouseUpHandler,false,0,true);
			_eventBinder.addListener(DomGlobals.stage, Event.MOUSE_LEAVE,stage_mouseUpHandler,false,0,true);
		}
		/**
		 * 计算当前的选中项列表
		 */		
		...
		private function stage_mouseUpHandler(event:Event):void
		{
			...
			_eventBinder.removeListener(DomGlobals.stage, Event.MOUSE_LEAVE,stage_mouseUpHandler);
