package org.flexlite.domUI.core
{
	...
	import org.flexlite.domUI.managers.ILayoutManager;
	...
	public class DomGlobals
	{
		...
		dx_internal static function initlize(stage:Stage):void
		{
			...
			try
			{
				layoutManager = Injector.getInstance(ILayoutManager);
			}
			catch (e:Error)
			{
		 ...
		 * 延迟渲染布局管理器
		 */
		dx_internal static var layoutManager:ILayoutManager;
		/**
		 * 焦点管理器
		 */
		...
		public static function setLayoutManager(instance:ILayoutManager):void
		{
